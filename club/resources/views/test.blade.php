...
<button type="submit" style="margin-left:1350px;" class="btn3"> <a href="{{ route('logout') }}"  class="btn btn-icon3" ></a></button>
  ...
  <a href="/admin"><div class="button button-3">les demandes</a></div>
        ...
        <tr >
            ...
            <td>
                  <form action="{{ route('utilisateurs.destroy', $user) }}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button type="submit" id="sup">Supp</button>  
                   </form> 
            </td>
            <td>
               <button id="ed"><a href="{{ route('utilisateurs.edit', $user) }}" >Éditer</a></button>
            </td>
                <style>
                  #ed{
